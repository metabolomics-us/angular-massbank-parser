...
class MassbankParserLibService {
    constructor(logger) {
        this.logger = logger;
        /**
...
MassbankParserLibService.ɵfac = function MassbankParserLibService_Factory(t) { return new (t || MassbankParserLibService)(ɵɵinject(NGXLogger)); };
MassbankParserLibService.ɵprov = ɵɵdefineInjectable({ token: MassbankParserLibService, factory: MassbankParserLibService.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { ɵsetClassMetadata(MassbankParserLibService, [{
        type: Injectable,
        args: [{
                providedIn: 'root'
            }]
...
class MassbankParserLibModule {
}
MassbankParserLibModule.ɵmod = ɵɵdefineNgModule({ type: MassbankParserLibModule });
MassbankParserLibModule.ɵinj = ɵɵdefineInjector({ factory: function MassbankParserLibModule_Factory(t) { return new (t || MassbankParserLibModule)(); }, providers: [MassbankParserLibService], imports: [[
            LoggerModule.forRoot({
                level: NgxLoggerLevel.DEBUG,
                serverLogLevel: NgxLoggerLevel.OFF
            })
        ]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(MassbankParserLibModule, { imports: [LoggerModule] }); })();
/*@__PURE__*/ (function () { ɵsetClassMetadata(MassbankParserLibModule, [{
        type: NgModule,
        args: [{
                imports: [
                    LoggerModule.forRoot({
...
export { MassbankParserLibModule, MassbankParserLibService };
//# sourceMappingURL=massbank-parser-lib.js.map
