(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('massbank-parser-lib', ['exports', '@angular/core', 'ngx-logger'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['massbank-parser-lib'] = {}, global.ng.core, global.i1));
}(this, (function (exports, i0, i1) { 'use strict';

    var MassbankParserLibService = /** @class */ (function () {
        function MassbankParserLibService(logger) {
            var _this = this;
            this.logger = logger;
            /**
            ...
            this.convertWithCallback = function (data, callback) {
                ...
                if (ions.length && spectrum.names.length) {
                    ...
                    _this.logger.warn("was no able to find valid spectra for record:\n\n" + data + "\n\n build object was:\n\n" + JSON.stringify(spectrum));
                }
            };
            /**
             * converts the data using a callback
        ...
        return MassbankParserLibService;
    }());
    MassbankParserLibService.ɵfac = function MassbankParserLibService_Factory(t) { return new (t || MassbankParserLibService)(i0.ɵɵinject(i1.NGXLogger)); };
    ...
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(MassbankParserLibService, [{
                type: i0.Injectable,
                args: [{
                        providedIn: 'root'
                    }]
    ...
    var MassbankParserLibModule = /** @class */ (function () {
        function MassbankParserLibModule() {
        }
        return MassbankParserLibModule;
    }());
    ...
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(MassbankParserLibModule, [{
                type: i0.NgModule,
                args: [{
                        imports: [
                            i1.LoggerModule.forRoot({
    ...
    exports.MassbankParserLibModule = MassbankParserLibModule;
    exports.MassbankParserLibService = MassbankParserLibService;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=massbank-parser-lib.umd.js.map
